...
outer_cv <- rsmp("cv", folds = outer_folds)
rr_S <- resample(
  task_S,
  inner_tuner_S,
  outer_cv
...
autoplot(rr_sev, measure = msr("regr.rmse"), type = "boxplot")
autoplot(final_tuner$learner, type = "importance", top_n = 20)

rr_S$predictions()[[1]]
autoplot(rr_S$predictions()[[1]], type = "residual")

autoplot(rr_S$prediction(), type = "residual")


rr_S$predictions()[[1]]$response

qqplot(rr_S$predictions()[[1]]$response, rr_S$predictions()[[1]]$truth)
abline(a = 0, b= 1)
