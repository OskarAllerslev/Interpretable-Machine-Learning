...
The results of the nested cross-validation are as follows: 
```{r boxplot‐kun, echo=FALSE, message=FALSE, warning=FALSE, results='hide', out.width= "50%"}
...
hyper_tab_twd <- gt::gt(enframe(best_params, name = "parameter", value = "value"))
print(hyper_tab_twd)
...
vi skal skrive noget mere til ovenstående 
